  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      {/* ══════════════════════════════════════════
          FIXED NAV
      ══════════════════════════════════════════ */}
      <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-white/98 border-b border-slate-100">
      ...
      <div className="h-screen overflow-y-scroll snap-y snap-mandatory [overscroll-behavior-y:contain]">
        ...
        <section className="h-screen snap-start bg-white flex flex-col [will-change:transform]">
          <div className="flex-1 max-w-6xl mx-auto w-full px-5 pt-24 pb-4 grid lg:grid-cols-2 gap-12 items-center overflow-hidden">
            ...
            <div ref={heroLeft}>
              ...
              <h1 className="text-5xl lg:text-[64px] font-black leading-[1.03] tracking-tight text-slate-900 mb-6"
              ...
              <Link href="/login?mode=signup"
                className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-base px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-emerald-100 hover:shadow-emerald-200 hover:-translate-y-0.5">
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                {["No subscription fee", "Any skill level", "Your neighbourhood"].map((t) => (
                  <span key={t}
                    className="flex items-center gap-1.5 text-xs font-medium text-slate-600 bg-slate-50 border border-slate-100 px-3 py-1.5 rounded-full">
        ...
        {/* ── 2. HOW IT WORKS ── */}
        <section id="how-it-works" className="h-screen snap-start bg-emerald-950 flex flex-col justify-center px-5 py-16 relative overflow-hidden [will-change:transform]">
          {/* Logo watermark */}
          ...
          <div className="max-w-6xl mx-auto w-full relative z-10">
            ...
            <div ref={howTitle} className="text-center mb-14">
              <span className="text-emerald-500/70 text-xs font-bold tracking-[.18em] uppercase block mb-3">
                How it works
              </span>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {([
                ...
                <div ref={refEl} key={n}
                  className="relative bg-white/[0.06] border border-white/10 rounded-3xl p-8 overflow-hidden hover:bg-white/[0.09] transition-colors duration-300">
                  {/* Watermark number */}
                  <span
                  ...
                  <div className="relative z-10">
                    <div className="w-11 h-11 bg-emerald-500 rounded-xl flex items-center justify-center mb-6">
                      <span className="text-white text-xs font-black" style={{ fontFamily: "var(--font-space-grotesk)" }}>{n}</span>
                    </div>
                    <h3 className="text-white font-bold text-xl mb-3" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                      {title}
                    </h3>
        ...
        {/* ── 3. SPORTS ── */}
        <section id="sports" className="h-screen snap-start bg-slate-900 flex flex-col justify-center px-5 py-16 relative overflow-hidden [will-change:transform]">
          {/* Logo watermark */}
          ...
          <div className="max-w-6xl mx-auto w-full relative z-10">
            ...
            <div ref={sportsTitle} className="text-center mb-10">
              <span className="text-emerald-500 text-xs font-bold tracking-[.18em] uppercase mb-4 block">Sports</span>
              <h2 className="text-4xl lg:text-5xl font-black text-white tracking-tight"
                style={{ fontFamily: "var(--font-space-grotesk)" }}>
                Every sport. Your area.
              </h2>
              <p className="text-slate-400 mt-3 text-base">From 5-a-side to yoga — find your activity or create one.</p>
            </div>

            <div ref={sportsGrid} className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-3">
        ...
        {/* ── 4. COMMUNITY ── */}
        <section id="community" className="h-screen snap-start bg-slate-50 flex flex-col justify-center px-5 py-16 relative overflow-hidden [will-change:transform]">
          ...
          <div className="max-w-6xl mx-auto w-full relative z-10">
            ...
            <div ref={commTitle} className="text-center mb-12">
              <span className="text-emerald-600 text-xs font-bold tracking-[.18em] uppercase mb-4 block">Community</span>
              <h2 className="text-4xl lg:text-5xl font-black text-slate-900 tracking-tight"
                style={{ fontFamily: "var(--font-space-grotesk)" }}>
                Real people. Real games.
              </h2>
              <p className="text-slate-500 mt-3 text-base">What the PeerFit community says.</p>
            </div>

            <div ref={commCards} className="grid md:grid-cols-3 gap-6">
        ...
        <section className="h-screen snap-start bg-emerald-950 flex flex-col relative overflow-hidden [will-change:transform]">
          ...
          {/* CTA body */}
          <div className="flex-1 flex flex-col justify-center items-center px-5 relative z-10">
            <div ref={ctaContent} className="max-w-2xl text-center">
              <div className="flex justify-center mb-8">
                <Image src="/images/peerfit-logo.png" alt="PeerFit" width={160} height={107} className="h-16 w-auto object-contain opacity-80" />
              </div>
              <h2
                className="text-6xl lg:text-[88px] font-black text-white leading-[0.92] tracking-tight mb-7"
                style={{ fontFamily: "var(--font-space-grotesk)" }}>
                Ready<br />to play?
              </h2>
              <p className="text-emerald-300/75 text-lg mb-10 leading-relaxed max-w-sm mx-auto">
                Join PeerFit for free and find local games in your sport today.
              </p>
              <Link href="/login?mode=signup"
                className="inline-flex items-center gap-2.5 bg-emerald-500 hover:bg-emerald-400 text-white font-bold text-lg px-9 py-4 rounded-2xl transition-all shadow-2xl shadow-emerald-900/60 hover:scale-[1.03] hover:-translate-y-0.5">
          ...
          <div className="relative z-10 px-5 py-5 border-t border-white/[0.07]">
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <nav className="flex gap-5 text-xs text-emerald-800">
                {[
