                ...
                <div className="flex items-center gap-1 p-1 bg-muted/40 rounded-2xl border border-border/40">
                  { ([
                    ...
                    <button
                      ...
                      className={ `px-3.5 py-1.5 rounded-xl text-sm font-medium transition-all ${feedView === key
                          ? key === "live"
                ...
                <div className="flex items-center gap-1 p-1 bg-muted/40 rounded-2xl border border-border/40">
                  { (["newest", "oldest"] as const).map((order) => (
                    <button
                      ...
                      className={ `px-3 py-1.5 rounded-xl text-xs font-medium transition-all ${sortOrder === order
                          ? "bg-background shadow-sm text-foreground border border-border/60"
                          : "text-muted-foreground hover:text-foreground"
                        }` }
                    >
                            ...
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              { isHost ? (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className={ `h-8 px-4 text-xs rounded-xl font-bold shrink-0 shadow-sm ${isJoined
                    ...
                    <div className="flex gap-2">
                      { (["public", "private"] as const).map((v) => (
                        <button
                          ...
                          className={ `flex-1 py-2 text-sm rounded-lg border transition-all flex items-center justify-center gap-1.5 ${editForm.visibility === v
                    ...
                    <div className="flex gap-2">
                      { (["public", "private"] as const).map((v) => (
                        <button
                          ...
                          className={ `flex-1 py-2 text-sm rounded-lg border transition-all flex items-center justify-center gap-1.5 ${createForm.visibility === v
                              ? "border-primary bg-primary/10 text-primary font-semibold"
                              : "border-border/50 bg-muted/30 text-muted-foreground hover:border-primary/50"
                            }` }
                        >
